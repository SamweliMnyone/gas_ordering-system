...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `register`(`firstname`, `lastname`, `email`, `address`, `phonenumber`, `choice`, `password`) VALUES ('$firstname','$lastname','$email','$address','$phonenumber','Supplier','$password') ";
    ...
    if($result){
        ...
        echo "<script>
            ...
            window.location.href = 'admin_add_supplier.php';
        </script>";
    }
}
...
<div style="display: flex; gap: 15px; position: scroll;">
    ...
    <div style="height: 100vh; width: 86%; padding-top: 20px; flex: content; position: scroll; display: flex; justify-content: center; align-items: center;margin-top:180px">
        <div style="margin-top: -20px;">
            <form method="POST" style="padding-top: 30px; width: 400px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1); padding: 20px; border-radius: 8px;">
                <h3 style="text-align:center; margin-bottom: 20px;">Register Customers</h3>
                <div class="mb-3">
