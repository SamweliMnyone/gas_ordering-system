...
<div style="height: 100vh; width: 86%;padding-top: 110px;position:scroll;">
        ...
        <?php
            ...
            $sql = "SELECT * FROM register  WHERE `choice`= 'Customer'";
        ...
        ?>
            <tr>
                ...
                <td><a href="delete_admin_manage_customer.php?id=<?php echo $row['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
