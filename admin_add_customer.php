...
if(isset($_POST['submit'])){
    ...
    $password = secures(md5($_POST['password']));
      ...
      $sql = "INSERT INTO `register`(`firstname`, `lastname`, `email`, `address`, `phonenumber`, `choice`, `password`) VALUES ('$firstname','$lastname','$email','$address','$phonenumber','Customer','$password') ";
